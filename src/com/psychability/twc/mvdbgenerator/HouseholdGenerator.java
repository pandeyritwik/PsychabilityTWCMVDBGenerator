...
public class HouseholdGenerator
{
    ...
    public static void main( String[] args ) throws UnknownHostException
    {
        ...
        new HouseholdRecordsGenerator( householdCollection, new Household( Utility.getRandomUUID( 40 ) + "-"
            + String.valueOf( rand.nextInt( 2 ) ), dmaId ), writtenRecords, records ).start();
        //		}
    }
...
class HouseholdRecordsGenerator extends Thread
{
    ...
    public HouseholdRecordsGenerator( DBCollection householdCollection, Household household, AtomicInteger writtenRecords,
        int totalRecords )
    {
